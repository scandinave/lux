 ...
 * @private
 */
export function transformKeys<T extends Object | Array<unknown>>(
  source: T,
 ...
 * @private
 */
export function camelizeKeys<T extends Object | Array<unknown>>(
  source: T,
  deep?: boolean
): T {
 ...
 * @private
 */
export function dasherizeKeys<T extends Object | Array<unknown>>(
  source: T,
  deep?: boolean
): T {
 ...
 * @private
 */
export function underscoreKeys<T extends Object | Array<unknown>>(
  source: T,
  deep?: boolean
): T {
